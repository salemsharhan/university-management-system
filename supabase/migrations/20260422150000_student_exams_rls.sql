-- Student e-learning exams: read exams/questions and submit/save attempts.
-- Uses helper: public.current_student_id(), public.current_app_user_role()

-- ---------------------------------------------------------------------------
-- subject_exams: students can SELECT exams for their enrolled classes
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- subject_exam_questions: students can SELECT questions when exam is open/closed/released
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- exam_submissions: students can SELECT/INSERT/UPDATE own submission for enrolled exam
-- Use status:
--   EX_DRF: draft/autosave
--   EX_SUB: final submitted
--   EX_GRD: graded (set by staff)
-- ---------------------------------------------------------------------------
