...
export function getApplicationExportColumnDefs(isArabic, getStatusLabel) {
  ...
  return [
    ...
    { key: 'specialization', header: L('Specialization', 'التخصص السابق'), get: (a) => a.specialization, width: 18 },
    { key: 'language_of_study', header: L('Language of study', 'لغة الدراسة'), get: (a) => a.language_of_study, width: 14 },
    { key: 'language_certificate_name', header: L('Language certificate', 'شهادة اللغة'), get: (a) => a.language_certificate_name, width: 16 },
    { key: 'language_certificate_result', header: L('Certificate result', 'نتيجة الشهادة'), get: (a) => a.language_certificate_result, width: 14 },
    { key: 'title', header: L('Title', 'اللقب'), get: (a) => a.title, width: 8 },
    ...
    { key: 'referral_source', header: L('Referral source', 'كيف عرف عنا'), get: (a) => a.referral_source, width: 16 },
  ]
}
