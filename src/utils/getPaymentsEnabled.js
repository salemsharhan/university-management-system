 ...
 *
 * Precedence:
 * 1) If college.financial_settings.payments_enabled is explicitly set (true/false), use it (per-college override).
 * 2) Otherwise use university_settings.financial_settings.payments_enabled when set (university-wide default for all colleges).
 * 3) Default: true (payments enabled).
 *
