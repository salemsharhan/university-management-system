        ...
        <div className="mx-auto grid min-h-screen w-full max-w-6xl grid-cols-1 lg:grid-cols-2">
          ...
          <div className="relative hidden lg:flex flex-col justify-between p-10">
            <div className="absolute inset-0">
              ...
              <div className="absolute bottom-10 right-0 h-80 w-80 rounded-full bg-red-200 blur-3xl opacity-70" />
              <div
            ...
            <div className="w-full max-w-md">
              ...
              <div className="rounded-3xl bg-white shadow-xl ring-1 ring-slate-200 p-7 lg:p-8">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-600">Use your university account.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                  ...
                  <div className="text-center text-sm text-slate-600">
                    ...
                    <Link to="/signup" className="font-extrabold text-slate-900 hover:underline">
                      Sign up
                    </Link>
                  </div>
                </form>
              ...
              <p className="mt-6 text-center text-xs text-slate-500 lg:hidden">© 2025 Imam Bukhari University (IBU).</p>
            </div>
          </div>
        </div>
      </div>
