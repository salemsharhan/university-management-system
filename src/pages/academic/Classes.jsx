          ...
          {filteredClasses.map((cls) => (
            ...
            >
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <p><strong>Subject:</strong> {cls.subjects?.code} - {cls.subjects?.name_en}</p>
                <p><strong>Semester:</strong> {cls.semesters?.name_en}</p>
                <p><strong>Section:</strong> {cls.section}</p>
                <p><strong>Capacity:</strong> {cls.enrolled}/{cls.capacity}</p>
