    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage academic semesters</p>
        </div>
        <button
          ...
          {filteredSemesters.map((semester) => (
            ...
            >
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <p><strong>Academic Year:</strong> {semester.academic_years?.name_en}</p>
                <p><strong>Start:</strong> {new Date(semester.start_date).toLocaleDateString()}</p>
                <p><strong>End:</strong> {new Date(semester.end_date).toLocaleDateString()}</p>
